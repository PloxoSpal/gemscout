...
class UserOrm(Base):
    ...
    complaints_sent: Mapped[list["UserComplaintOrm"]] = relationship(
        foreign_keys="UserComplaintsOrm.complainant_id",
        back_populates="complainant",
    )

    complaints_received: Mapped[list["UserComplaintOrm"]] = relationship(
        foreign_keys="UserComplaintsOrm.defendant_id",
...
class UserComplaintOrm(Base):
    ...
    complainant: Mapped["UserComplaintOrm"] = relationship(
        foreign_keys=[complainant_id],
    )

    defendant: Mapped["UserComplaintOrm"] = relationship(
